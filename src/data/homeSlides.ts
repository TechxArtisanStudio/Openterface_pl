...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'Zobacz produkt', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Zobacz produkt', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Zobacz produkt', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Akcesoria', href: '/accessories/' },
